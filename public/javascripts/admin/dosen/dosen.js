document.addEventListener('DOMContentLoaded', async () => {
    ...
    for (let index = 0; index < dataDosen.length; index++) {
        ...
        buttonEdit.setAttribute('data-bs-target', `#exampleModal2_${dataDosen[index].nip_dosen}`) // Gunakan ID unik
        ...
        div5.setAttribute('id', `exampleModal2_${dataDosen[index].nip_dosen}`) // Gunakan ID unik
